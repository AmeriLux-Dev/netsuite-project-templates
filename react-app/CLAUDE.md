...
| Command | Use it for |
|---|---|
| `npm run generate` | Regenerate `api/src/repositories/generated/` and `api/src/types/models.gen.ts` from the models, then `api/src/scripts.gen.ts` and `client/src/api/` from the controllers. Run after touching a model or a controller. |
