...
import { readActiveUser } from '../../src/repositories/activeUserRepository';

// N/runtime resolves to the stub the api package ships; the repository is tested on how it reads the session.
