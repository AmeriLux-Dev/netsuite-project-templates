 ...
 * only a role allowed to read role assignments can query it; see scripts.userRoles in common/netsuite.ts.
 * Run `npm run generate` after editing: it refreshes api/src/repositories/generated/ and common/types/models.gen.ts.
 */
