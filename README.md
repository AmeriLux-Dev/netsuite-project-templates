...
scripts/checkHowToUse.mjs   writes every worked example of react-app/how-to-use into the e2e scaffold, then generates, typechecks, lints, tests and builds it (run by e2e.mjs)
scripts/snippetExpansion.mjs   VS Code snippet expansion, shared by the two checks above
